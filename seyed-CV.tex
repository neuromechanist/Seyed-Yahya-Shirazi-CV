...
% \end{itemize}
{\bf Research focus:} My research is mainly based on an NSF/FDA grant to quantify the changes in brain-muscle connectivity after stroke, using high-density EEG and high-density EMG. We hope to provide insights on how the connectivity patterns improve with rehabilitation toward developing a medical device development tool (MDDT) to evaluate pre-market rehabilitation devices. \\[2pt]


{\sl University of Central Florida (UCF)}, Orlando , FL \hfill Jan. 2017 -- April 2021 \\
...
\vspace{8pt} % Gap between title and text
O’ Keeffe R., \textbf{Shirazi S.Y.}, Jahed S., Bilaloglu S., Raghavan P., Bighamian R., and Atashzar S.F. (drafted) \textit{ Info-MuNet: Information Theoretic Functional Muscle Network Indicates Stroke Recovery},{\footnotesize will be submitted to} Scinence Advances, 2021

\textbf{Shirazi, S.Y.} and Huang, H. J. (in preparation)\textit{ Group-level functional corticomucular connectivity during seated locomotor perturbations for young and older adults},{\footnotesize will be submitted to} Neuroimage, 2021

\textbf{Shirazi, S.Y.} and Huang, H. J. (drafted)\textit{ Young adults use task specific strategies while older adults use non-specific muscle co-contraction strategies during perturbed stepping},{\footnotesize will be submitted to} Scientific Reports, 2021
