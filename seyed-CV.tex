...
\vspace{8pt} % Gap between title and text
{\sl Doctor of Philosophy}, Mechanical Engineering \hfill Jan. 2017 - Aug. 2021 \\ 
...
\vspace{8pt} % Gap between title and text
\textbf{Shirazi, S.Y.} and Huang, H. J. (in preparation)\textit{Young adults use task specific strategies while older adults use non-specific muscle co-contraction strategies during perturbed stepping}, eLife, 2021
