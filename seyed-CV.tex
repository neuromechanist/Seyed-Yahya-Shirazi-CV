...
{\bf Secondary Focus:} Improving the sensor design and the processing pipelines to overcome motion artifacts in biological signals. The new sensor design involves dual-layer EEG, where the second layer only records artifacts from the environment. The processing improvements include a subject-specific pipeline for detection and rejection of the artifacts.
